...
/* PORT: anim records are byte-packed at odd offsets — byte access for ARM
 * (identical results on any little-endian target, cf. game/DEFINES.H) */
...
{
    return (ULONG)ptr[0] | ((ULONG)ptr[1] << 8) |
...
static void write_dword(UBYTE *ptr, ULONG value)
{
    ptr[0] = (UBYTE)value;
    ptr[1] = (UBYTE)(value >> 8);
    ptr[2] = (UBYTE)(value >> 16);
    ptr[3] = (UBYTE)(value >> 24);
}
