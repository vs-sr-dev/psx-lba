...
#if !defined(PORT_SDL) && !defined(PORT_NDS) && !defined(PORT_PSX) /* PORT: duplicate symbol — the game overrides Message() in PERSO.C;
					the Watcom librarian only pulled this one when unresolved */
